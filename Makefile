...
PROJECT_NAME = aerobotics
PYTHON_INTERPRETER = python3

export DOCKER=docker
export PWD=`pwd`

export IMAGE_NAME=$(PROJECT_NAME)_image


export CONTAINER_NAME=$(PROJECT_NAME)_container
...
create-container:
	-$(DOCKER) run -it -v $(PWD):/home/jovyan/ -p $(JUPYTER_HOST_PORT):$(JUPYTER_CONTAINER_PORT) --name $(CONTAINER_NAME) $(IMAGE_NAME)
